...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Shampoo Image field in *Hero → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.shampoo_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  shampoo_image: prismic.ImageField<never>;
